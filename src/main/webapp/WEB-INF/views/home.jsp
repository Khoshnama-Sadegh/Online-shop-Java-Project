...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img class="first-slide" src="<c:url value="/resource/images/banner14_1.jpg"/>" alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="second-slide" src="<c:url value="/resource/images/banner12_1.jpg"/>" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="item">
            <img class="third-slide" src="<c:url value="/resource/images/banner13_1.jpg"/>" alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
    ...
    <div class="row">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/laptop.jpg"/>" alt="Generic placeholder image" width="180" height="180">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/mobile.jpg"/>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/camera.jpg"/>" alt="Generic placeholder image" width="140" height="140">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/tv.jpg"/>" alt="Generic placeholder image" width="190" height="190">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/refrigerator.jpg"/>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/tablet.jpg"/>" alt="Generic placeholder image" width="190" height="190">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/micro%20oven.jpg"/>" alt="Generic placeholder image" width="190" height="190">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/dvd.jpg"/>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/fan.jpg"/>" alt="Generic placeholder image" width="190" height="190">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/printer.jpg"/>" alt="Generic placeholder image" width="190" height="190">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/desktop.jpg"/>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/washing%20machines.jpg"/>" alt="Generic placeholder image" width="190" height="190">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/ipad.jpg"/>" alt="Generic placeholder image" width="190" height="190">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/game%20consol.jpg"/>" alt="Generic placeholder image" width="140" height="140">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resource/images/router.jpg"/>" alt="Generic placeholder image" width="190" height="190">
        ...
        <div class="container">
            ...
            <div class="row user1testimonial">
                ...
                <div class="col-md-2">
                    ...
                    <div class="clientimg">
                        <img class="img-circle" src="<c:url value="/resource/images/user1.jpg"/>" alt="Generic placeholder image" width="140" height="140">
            ...
            <div class="row user1testimonial2">
                <div class="col-md-2">
                    ...
                    <div class="clientimg">
                        ...
                        <img class="img-circle" src="<c:url value="/resource/images/user2.jpg"/>" alt="Generic placeholder image" width="140" height="140">
                    </div>
                </div>
